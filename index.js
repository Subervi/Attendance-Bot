...
server.all('/', (req, res) => {    
    res.send('El bot está activo!'); // Responder cuando reciba una solicitud
});

function keepAlive() {
    server.listen(3000, () => {
        console.log('El servidor está listo'); // Mensaje para indicar que el servidor está activo
    });
}
...
keepAlive();  // Llama a esta función para mantener el bot vivo
